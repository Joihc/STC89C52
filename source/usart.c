...
//		== 63   修改密码  
	...
	{        
		if(CompareCMD_tail(1,2,deviceID))
		{
			...
			else if(CompareCMD_tail(4,2,"52"))//		== 52		最大供电电压
			{
				Set_Menu2_Value(2,trans_int);	
			}
			else if(CompareCMD_tail(4,2,"53"))//		== 53		最小供电电压
			{
				Set_Menu2_Value(3,trans_int);	
			}
			else if(CompareCMD_tail(4,2,"54"))//		== 54		最大线盘电流
			{
				Set_Menu2_Value(4,trans_int);	
			}
			else if(CompareCMD_tail(4,2,"55"))//		== 55		最大线盘温度
			{
				Set_Menu2_Value(5,trans_int);	
			}
			else if(CompareCMD_tail(4,2,"56"))//		== 56		通用线盘温度
			{
				Set_Menu2_Value(6,trans_int);	
			}
			else if(CompareCMD_tail(4,2,"57"))//		== 57		最大锅内温度
			{
				Set_Menu2_Value(7,trans_int);	
			}				
			else if(CompareCMD_tail(4,2,"58"))//		== 58		最大漏料温度	
			{
				Set_Menu2_Value(8,trans_int);	
			}
			else if(CompareCMD_tail(4,2,"59"))//		== 59		最大IGBT频率
			{
				Set_Menu2_Value(9,trans_int);	
			}
			else if(CompareCMD_tail(4,2,"60"))//		== 60		最小IGBT频率
			{
				Set_Menu2_Value(10,trans_int);	
			}
			else if(CompareCMD_tail(4,2,"61"))//		== 61		最大IGBT温度
			{
				Set_Menu2_Value(11,trans_int);	
			}
			else if(CompareCMD_tail(4,2,"62"))//		== 62		限制工作时间
			{
				Set_Menu2_Value(12,trans_int);	
			}
			else if(CompareCMD_tail(4,2,"63"))//		== 63   恢复出厂设置
			{
